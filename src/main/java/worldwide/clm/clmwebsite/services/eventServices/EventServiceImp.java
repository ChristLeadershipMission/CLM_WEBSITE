...
public class EventServiceImp implements EventService {
    ...
    private Event updateEvent(EventUpdateRequest eventUpdateRequest) {
        ...
        if(eventUpdateRequest.getTheme()!=null){
            event.setTheme(eventUpdateRequest.getTheme());
        }
        ...
        if(eventUpdateRequest.getFlier()!=null){
            event.setFlier(eventUpdateRequest.getFlier());
        }
    ...
    public EventResponse findById (Long id) throws EventNotFoundException {
        ...
        return modelMapper.map(foundEvent, EventResponse.class);
    }
}
